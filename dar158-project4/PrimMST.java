...
public class PrimMST {
    ...
    private DirectedDiWeightEdge[] edgeTo;        // edgeTo[v] = shortest edge from tree vertex to non-tree vertex
    ...
    public Iterable<DirectedDiWeightEdge> edges() {
        Queue<DirectedDiWeightEdge> mst = new Queue<DirectedDiWeightEdge>();
        for (int v = 0; v < edgeTo.length; v++) {
            DirectedDiWeightEdge e = edgeTo[v];
            if (e != null) {
                mst.enqueue(e);
            }
        }
    ...
    public double weight() {
        double weight = 0.0;
        for (DirectedDiWeightEdge e : edges())
            weight += e.distance();
        return weight;
    }
